<section class="card border-primary container p-5 w-50 mt-5">
    <h3 class="title">Cálculo de fatorial:</h3>
    <form class="form row" action="/lista2/ex5/resposta" method="POST">
        <div class="col-7">
            <label for="number" class="form-label fs-5 mt-2">Informe um número para calcular seu fatorial:</label>
